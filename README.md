...
Contributions are welcome. See [CONTRIBUTING.md](CONTRIBUTING.md) for local dev setup, code quality tooling, and the branching workflow (feature branch → `staging` → `master`).
